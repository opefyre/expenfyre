  ...
  return (
    <div className="h-full flex flex-col w-full max-w-full">
        ...
        <div className="flex items-center justify-between mb-4 flex-shrink-0">
            ...
            <p className="text-gray-600 dark:text-gray-300 mt-1">Manage your expenses and track spending</p>
          </div>
                <button
              ...
              {paginatedExpenses.map((expense) => {
                ...
                return (
                  <div
                    ...
                    className="bg-white dark:bg-gray-800 rounded-lg border border-slate-200 dark:border-gray-700 p-4 hover:shadow-md transition-shadow cursor-pointer"
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center space-x-2 mt-1">
                              <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-blue-100 dark:bg-blue-600 text-blue-800 dark:text-blue-100">
                                {category?.name || 'Unknown'}
                              </span>
                              {budget && (
                              <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-green-100 dark:bg-green-600 text-green-800 dark:text-green-100">
                              ...
                              {expense.tags && (
                                <div className="flex flex-wrap gap-1 mt-1">
                                  ...
                                  <span key={index} className="inline-flex items-center px-1.5 py-0.5 rounded text-xs bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400">
                                      {tag.trim()}
                                    </span>
                                  ))}
                                </div>
        ...
        {viewingExpense && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white dark:bg-gray-800 rounded-lg max-w-md w-full max-h-[90vh] overflow-y-auto">
              <div className="p-6">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Expense Details</h2>
                  <button
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        <div className="flex justify-between">
          ...
          <span className="font-medium text-gray-900 dark:text-gray-100">{category?.name || 'Unknown'}</span>
        </div>
        
        <div className="flex justify-between">
          <span className="text-gray-600 dark:text-gray-400">Budget:</span>
          <span className="font-medium text-gray-900 dark:text-gray-100">{getBudgetDisplayName(budget)}</span>
        </div>
        
        <div className="flex justify-between">
          <span className="text-gray-600 dark:text-gray-400">Date:</span>
          <span className="font-medium text-gray-900 dark:text-gray-100">{new Date(expense.date).toLocaleDateString()}</span>
        </div>
        
        <div className="flex justify-between">
          <span className="text-gray-600 dark:text-gray-400">Month:</span>
          <span className="font-medium text-gray-900 dark:text-gray-100">{expense.month}</span>
          </div>
        ...
        {expense.tags && (
          <div>
            ...
            <div className="flex flex-wrap gap-1">
              {expense.tags.split(',').map((tag, index) => (
                <span key={index} className="inline-flex items-center px-2 py-1 rounded text-sm bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400">
                  {tag.trim()}
                </span>
              ))}
            </div>
